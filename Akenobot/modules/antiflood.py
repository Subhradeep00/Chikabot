...
from Akenobot import TIGERS, WOLVES, dispatcher
...
from Akenobot.modules.sql import antiflood_sql as sql
...
from Akenobot.modules.sql.approve_sql import is_approved
...
def check_flood(update, context) -> str:
    ...
    try:
        ...
        if getmode == 1:
            ...
            tag = "TMUTE"
        send_message(
            update.effective_message, "Now Shut Up You Over Smart!!!\n{}!".format(execstrings)
        )
