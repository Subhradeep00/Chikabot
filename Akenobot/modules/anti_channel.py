...
from Akenobot.modules.helper_funcs.decorators import Akenocmd, Akenomsg
...
@Akenocmd(command="antichannel", group=100)
...
@Akenomsg(Filters.chat_type.groups, group=110)
